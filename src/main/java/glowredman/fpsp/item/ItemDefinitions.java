...
public enum ItemDefinitions {
    ...
    // Io
    IoRockDust(10),
    MetalMeteoricIronDust(60),
    IoDust(102),

    // Mercury
    MercuryRockDust(11),
    MetallicDust(61),
    MercurianIronDust(62),
    ...
    // Plongius
    PolongniusRockDust(27),
    PolongniusMeteoricIronDust(80),
    FloniumDust(81),

    // Barnarda Planets
    BarnardaCDust(28),
    BarnardaERockDust(29),
    BarnardaFRockDust(30),
    ...
    // Dark Asteroids
    DarkAsteroidRockDust(99),
    AlphereDust(100),
    DarkAsteroidDust(101),
    ...
    public ItemStack getItem(int amount) {
        return new ItemStack(FPSP.itemMeta, amount, this.getMeta());
    }
