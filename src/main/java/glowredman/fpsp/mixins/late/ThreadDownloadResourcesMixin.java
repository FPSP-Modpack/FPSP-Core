package glowredman.fpsp.mixins.late;
...
public class ThreadDownloadResourcesMixin {
    ...
    @ModifyConstant(
        constant = { @Constant(stringValue = "http://repo.creeperhost.net/ichun/static/assets.xml"),
            @Constant(stringValue = "http://cdn.redstone.tech/ichun/static/assets.xml") },
        method = "run()V",
        remap = false)
