...
public class OreGenerator implements IWorldGenerator {
	...
	private static List<String> biomesAmberOre = Arrays.asList("twilightforest.biomes.TFBiomeDarkForest",
			...
			"twilightforest.biomes.TFBiomeTwilightForest", "twilightforest.biomes.TFBiomeTwilightForestVariant");
	private static List<String> biomesTopazOre = Arrays.asList("twilightforest.biomes.TFBiomeClearing",
			"twilightforest.biomes.TFBiomeTwilightLake", "twilightforest.biomes.TFBiomeStream",
			"twilightforest.biomes.TFBiomeSwamp");
	private static List<String> biomesTanzaniteOre = Arrays.asList("twilightforest.biomes.TFBiomeDarkForestCenter",
			"twilightforest.biomes.TFBiomeEnchantedForest", "twilightforest.biomes.TFBiomeHighlands",
			"twilightforest.biomes.TFBiomeSnow");
	private static List<String> biomesMalachiteOre = Arrays.asList("twilightforest.biomes.TFBiomeFireSwamp",
	...
	void generateTwilightOres(Random random, int chunkX, int chunkZ, World world) {
		String biome = world.getBiomeGenForCoordsBody(chunkX * 16, chunkZ * 16).getBiomeClass().getSimpleName();
